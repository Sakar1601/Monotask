# Monotask Architecture Reference

> Deep reference for contributors: system design, database schema, auth flow, component/hook inventory, security model, and feature internals. For a quick overview and setup instructions, see [README.md](../README.md).
